...
<table align="right">
    <tr>
        <th><a href="index.html" target="_blank" id="zhuxiao">注销账号</a></th>
        <th><a href="设置.html" target="_blank">设置</a></th>
    </tr>
</table>
...
&lt;!&ndash; a标签标签的超链接  href属性设置连接的地址 target属性设置目标跳转&ndash;&gt;
